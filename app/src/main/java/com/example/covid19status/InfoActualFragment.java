...
public class InfoActualFragment extends Fragment {
    ...
    AdapterProvincias adapter;
    RecyclerView recycler;
    View vista;


    Activity activity;
    IComunicaFragment interfaceComunicacionEntreFragment;
    ...
    public void mostrarData(){
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int idProvin = listaProvincias.get(recycler.getChildAdapterPosition(v)).getIdProvincia();
                ...
                Log.v("Iddelaprov", idProvin+"");
                Call call = ApiClient.getApiService().getProvinciaId(idProvin);
                call.enqueue(new Callback() {
                    @Override
                    public void onResponse(Call call, Response response) {
                        Log.v("entro", response.isSuccessful() + "añgp");
                        if(response.isSuccessful()){
                            Log.v("entro 2", "y tambien Entro aca");
